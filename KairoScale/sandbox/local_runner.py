...
logger = get_logger("KairoScale.sandbox.local")
...
async def run_locally(
    ...
    artifact_dir = Path(tempfile.mkdtemp(prefix="KairoScale_artifacts_"))
    script_dir = Path(tempfile.mkdtemp(prefix="KairoScale_script_"))
    script_path = script_dir / "KairoScale_wrapper.py"
